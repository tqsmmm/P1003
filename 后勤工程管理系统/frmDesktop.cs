    ...
    public partial class frmDesktop : Form
    {
        ...
        private void btnReload_Click(object sender, EventArgs e)
        {
            ...
            if (bChecked == true)
            {
                ...
                {
                    if (txtPremises_Date.Text != string.Empty)
                    {
                        strSQL = $"{strSQL} Projects.Begin_Date >= '{txtPremises_Date.Text}-01-01' AND Projects.End_Date <= '{txtPremises_Date.Text}-12-31' AND ";
